...
SqlString.lobField = function(buffer){
    if(!buffer) return 'null';
    return 'to_blob(\''+buffer.toString('hex')+'\')';
};

SqlString.nextAutoIncrement = function(sequenceName){
        return sequenceName+'.NEXTVAL';
};

SqlString.escapeColumn = function(columnName){
        return '"'+columnName+'"';
};
